  ...
  <div class="container">
    ...
    <div id="profile-form">
      <form @submit.prevent>
        ...
        <div class="form-group row">
          <label for="inputProfilePhoto" class="col-sm-2 col-form-label"
            >個人頭像 Photo (Gravatar)</label
          >
          <div class="col-sm-10">
            <input
              type="text"
            ...
            <span class="help-block"
              >(輸入 Gravatar 的用戶號碼 -
              https://www.gravatar.com/avatar/<strong
                >205e460b479e2e5b48aec07710c08d50</strong
              >
              | <a href="https://gravatar.com">免費註冊一個頭像</a>)</span
            >
          </div>
        </div>
        <div class="form-group row">
          <label for="inputWebsite" class="col-sm-2 col-form-label"
            >個人網站 Website</label
          >
          <div class="col-sm-10">
            <input
              ...
              :value="user_attributes['website']"
            />
          </div>
        </div>
        <div class="form-group row">
          <label for="inputCalendy" class="col-sm-2 col-form-label"
            >開放其他人向你諮詢 Accept Mentoring</label
          >
          <div class="col-sm-10">
            <select class="form-control" id="inputAcceptMentoring">
              <option
                value="0"
                :selected="user_attributes['custom:accept_mentoring'] == 0"
              >
                No
              </option>
              <option
                value="1"
                :selected="user_attributes['custom:accept_mentoring'] == 1"
              >
                Yes
              </option>
            </select>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input
              ...
              :value="user_attributes['custom:calendy_url']"
            />
            <span class="help-block"
              >(<a href="https://calendly.com/">前往 Calendy</a>)</span
            >
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <textarea
            ...
            id="inputProfileBio"
            rows="20"
            v-model="user_attributes['profile']"
          ></textarea>
        </div>
        <div class="form-group row">
          <div class="col-sm-10">
            <button class="btn btn-primary" v-on:click="updateAttribute">
              Update
            </button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    getLatestTagsList() {
      ...
      if (
        JSON.stringify(this.user_attributes['custom:tags']) !==
    ...
    async updateAttribute() {
      try {
        ...
        let result = await this.$Amplify.Auth.updateUserAttributes(user, {
          ...
          'custom:accept_mentoring': document.getElementById(
            'inputAcceptMentoring'
          ).value,
